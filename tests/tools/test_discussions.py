...
class TestDiscussionTools:
    ...
    async def test_list_discussion_topics(self):
        ...
        with patch(
            ...
            result = await fetch_all_paginated_results(
                "/courses/12345/discussion_topics", {}
            )
    ...
    async def test_list_discussion_entries(self):
        ...
        with patch(
            ...
            result = await fetch_all_paginated_results(
                "/courses/12345/discussion_topics/1/entries", {}
            )
    ...
    async def test_post_discussion_entry(self):
        ...
        new_entry = {"message": "This is my reply"}
        ...
        with patch(
            ...
            result = await make_canvas_request(
                "post", "/courses/12345/discussion_topics/1/entries", data=new_entry
            )
    ...
    async def test_reply_to_discussion_entry(self):
        ...
        reply = {"message": "Reply to your post"}
        ...
        with patch(
            ...
            result = await make_canvas_request(
                "post",
                "/courses/12345/discussion_topics/1/entries/101/replies",
                data=reply,
            )
