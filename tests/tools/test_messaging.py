    ...
    async def test_send_conversation(self):
        ...
        with patch(
            ...
            result = await make_canvas_request(
                "post", "/conversations", data=message_data
            )
...
class TestAnnouncementTools:
    ...
    async def test_list_announcements(self):
        ...
        with patch(
            ...
            result = await fetch_all_paginated_results(
                "/courses/12345/discussion_topics", {"only_announcements": True}
            )
    ...
    async def test_create_announcement(self):
        ...
        with patch(
            ...
            result = await make_canvas_request(
                "post", "/courses/12345/discussion_topics", data=announcement_data
            )
    ...
    async def test_delete_announcement(self):
        ...
        with patch(
            ...
            result = await make_canvas_request(
                "delete", "/courses/12345/discussion_topics/303"
            )
